...
import { FilterIcon, PlusIcon, EditIcon, TrashIcon, MoreVerticalIcon, ClockIcon, AlertCircleIcon, RepeatIcon, CheckCircleIcon, CircleIcon, ChevronDownIcon, CalendarIcon } from '../icons/Icons';
...
const SalesTasks: React.FC = () => {
    ...
    const canViewAllTasks = currentUserRole?.id === 'admin' || currentUserRole?.id === 'sales_manager';
    ...
    }, [tasks, statusFilter, priorityFilter, showOldTasks, currentUser?.id, canViewAllTasks]);
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                {task.leadId && task.leadTitle && (
                                                    <div className="text-xs mt-1 flex items-center gap-1 text-purple-600">
